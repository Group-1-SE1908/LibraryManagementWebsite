                        ...
                        <div class="checkout-grid">
                                ...
                                <c:forEach var="cartItem" items="${cart.items}">
                                    <div class="item">
                                        ...
                                        <div class="item-info">
                                            ...
                                            <p>Giá: <strong><fmt:formatNumber value="${cartItem.book.price}" pattern="#,##0" /> ₫</strong> / cuốn</p>
                                            <p>Thành tiền: <strong><fmt:formatNumber value="${cartItem.subtotal}" pattern="#,##0" /> ₫</strong></p>
                                        </div>
                                    </div>
                                </c:forEach>
                            </div>
                            ...
                            <div class="section">
                                ...
                                <div class="summary-row">
                                    ...
                                    <span><fmt:formatNumber value="${totalValue}" pattern="#,##0" /> ₫</span>
                                </div>
                                <div class="summary-row">
                                    <span>Cọc (50%)</span>
                                    <span><fmt:formatNumber value="${totalDeposit}" pattern="#,##0" /> ₫</span>
                                </div>
                                ...
                                <form id="checkoutForm" action="${pageContext.request.contextPath}/cart/checkout/process" method="post">
                                    ...
                                    <button type="button" class="btn" onclick="showConfirmModal()">Thanh toán cọc & Đặt sách</button>
                                </form>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="modal-warning">
                                    ⚠️ Lưu ý quan trọng: Khi bạn thanh toán cọc, yêu cầu này sẽ được tạo và <strong>không thể hủy bỏ</strong>.
                                </div>
                                <div class="info-item">
                                ...
                                <div style="margin-top: 20px; padding-top: 20px; border-top: 2px solid #eee;">
                                    <p style="color: #333; font-weight: 500; margin-bottom: 8px;">Bạn có xác nhận thực hiện thanh toán không?</p>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn-modal btn-modal-cancel" onclick="closeConfirmModal()">Hủy bỏ</button>
                                <button type="button" class="btn-modal btn-modal-confirm" onclick="submitCheckoutForm()">Xác nhận & Thanh toán</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <script type="text/javascript">
                        ...
                        function showConfirmModal() {
                            ...
                            try {
                                ...
                                // Get values from summary rows
                                const summaryRows = document.querySelectorAll('.summary-row');
                                if (summaryRows.length >= 1) {
                                    const spans1 = summaryRows[0].querySelectorAll('span');
                                    if (spans1.length >= 2) {
                                        document.getElementById('modalTotalValue').textContent = spans1[1].textContent.trim();
                                    }
                                }
                                ...
                                if (summaryRows.length >= 2) {
                                    ...
                                    if (spans2.length >= 2) {
                                        document.getElementById('modalDeposit').textContent = spans2[1].textContent.trim();
                                    }
                                }
                            } catch(e) {
