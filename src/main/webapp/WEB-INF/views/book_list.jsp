...
<html lang="vi">
    ...
    <head>
        ...
        <style>
            ...
            /* Style cho nhóm nút thao tác của Staff */
            .book-card__staff-actions {
                display: flex;
                gap: 8px;
                margin-top: 12px;
                padding-top: 12px;
                            ...
                            <div class="book-card">
                                <a class="book-card__link"
                                   href="${pageContext.request.contextPath}${booksBasePath}/detail?id=${book.id}">
                                    ...
                                    <c:if test="${isStaff}">
                                        <div class="book-card__staff-actions">
                                            <a href="${pageContext.request.contextPath}${booksBasePath}/edit?id=${book.id}" 
                                               class="btn-action btn-edit">
                                                <span>✏️</span> Sửa
                                            </a>
                                            <button type="button" 
                                                    class="btn-action btn-delete" 
                                                    onclick="confirmDelete('${book.id}', '${fn:escapeXml(book.title)}')">
                                                <span>🗑️</span> Xóa
                                            </button>
                                        </div>
                                    </c:if>
