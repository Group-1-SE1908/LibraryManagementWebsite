            ...
            <body class="mp-body">
                        ...
                        <section class="cart-grid-section">
                            ...
                            <aside class="cart-summary-panel">
                                ...
                                <form class="borrow-form" method="post"
                                    ...
                                    <div class="borrow-details${borrowDetailsVisible ? ' borrow-details--visible' : ''}"
                                        data-borrow-details data-auto-show="${borrowDetailsVisible}">
                                        ...
                                        <div class="borrow-details-grid">
                                            <label class="form-group">
                                                ...
                                                <input type="email" name="contactEmail"
                                                    placeholder="Ví dụ: ban@mail.com" disabled required
                                ...
                                <a href="${pageContext.request.contextPath}/books" class="btn secondary">Tiếp tục xem
                                    sách</a>
                            </aside>
                        </section>
                    </c:if>
                    ...
                    <div class="shipping-dialog">
                        ...
                        <div class="shipping-form-grid">
                            <label class="form-group">
                                ...
                                <input type="text" data-shipping-field="recipient" placeholder="Ví dụ: Nguyễn Thị Hoa"
                                    required />
                            </label>
                            <label class="form-group">
                                <span>Số điện thoại</span>
                                <input type="tel" inputmode="tel" data-shipping-field="phone" placeholder="0901234567"
                                    required pattern="[0-9]{10,11}" title="Nhập 10 hoặc 11 chữ số" />
                            </label>
                            <label class="form-group">
                                <span>Tên đường / số nhà</span>
                                <input type="text" data-shipping-field="street" placeholder="118/2/14 Lê Văn Thọ"
                                    required />
                            </label>
                            <label class="form-group">
                                <span>Khối / căn hộ <span class="optional-label">(Tùy chọn)</span></span>
                                <input type="text" data-shipping-field="residence"
                                    placeholder="Tầng 4, Chung cư Phúc Nguyên" />
                            </label>
                            <label class="form-group">
                ...
                <div class="confirm-overlay" hidden data-confirm-overlay>
                    <div class="confirm-dialog">
                        ...
                        <p>Bạn đang chọn phương thức <strong data-confirm-method></strong>. Hãy xác nhận trước khi gửi
                            yêu cầu.</p>
