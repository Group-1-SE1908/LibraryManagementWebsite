                                            ...
                                            <tbody>
                                                <c:forEach var="comment" items="${pendingReplies}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="comment-preview"
                                                                title="${fn:escapeXml(comment.content)}">
                                                                ${fn:escapeXml(fn:substring(comment.content, 0,
                                                                50))}${fn:length(comment.content) > 50 ? '...' : ''}
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="${pageContext.request.contextPath}/comments?action=getComments&bookId=${comment.bookId}"
                                                                class="btn btn-primary">Xem & Trả lời</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
