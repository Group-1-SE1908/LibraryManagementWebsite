        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <head>
                ...
                <style>
                    ...
                    .lock-wrapper.open .lock-dropdown {
                        display: block;
                    }
                    ...
                    <div class="container-page">
                        <div class="panel">
                            ...
                            <div class="tab-bar">
                                ...
                                <a href="#tab-reports" class="tab-btn ${activeTab eq 'reports' ? 'active' : ''}"
                                        ...
                                        <c:forEach var="cmt" items="${comments}">
                                            <div class="feedback-row">
                                                <div class="feedback-content">
                                                    <div class="feedback-title">#${cmt.commentId} — ${cmt.fullName}
                                                    </div>
                                                    <div class="star">
                            ...
                            <div id="tab-reports" class="tab-content ${activeTab eq 'reports' ? 'active' : ''}">

                                <!-- SUB FILTER: Chưa xử lý / Đã xử lý -->
                                <div class="sub-filter-bar">
                                    <a href="#" class="sub-filter-btn active"
                                        onclick="filterReports('pending'); return false;">
                                        Chưa xử lý
                                        <c:if test="${pendingCount > 0}">
                                            ...
                                            <tbody>
                                                <c:forEach var="report" items="${reports}">
                                                    <tr class="report-row" data-status="${report.status}">
                                                        ...
                                                        <td style="color:#9ca3af; font-size:13px;">#${report.reportId}
                                                        </td>

                                                        <td>
                                                            <div class="reporter-name">${report.reporterFullName}</div>
                                                        </td>

                                                        <td>
                                                            <div class="comment-box">${report.commentContent}</div>
                                                            <div class="comment-author">Bởi:
                                                        ...
                                                        <td>
                                                            <span class="reason-tag">
                                                                <c:choose>
                                                                    <c:when test="${report.reason eq 'Harassment'}">Quấy
                                                                        rối</c:when>
                                                                    <c:when test="${report.reason eq 'Spam'}">Spam
                                                                    </c:when>
                                                                    <c:when test="${report.reason eq 'Hate Speech'}">
                                                                    ...
                                                                    <c:when test="${report.reason eq 'Violence'}">Bạo
                                                                        lực</c:when>
                                                        ...
                                                        <td>
                                                            <span class="status-badge status-${report.status}">
                                                                <c:choose>
                                                                    <c:when test="${report.status eq 'PENDING'}">Chờ xử
                                                                        lý</c:when>
                                                                    <c:when test="${report.status eq 'RESOLVED'}">Đã xử
                                                                        lý</c:when>
                                                                    <c:when test="${report.status eq 'IGNORED'}">Bỏ qua
                                                                    </c:when>
                                                                ...
                                                                <c:when test="${report.status eq 'PENDING'}">
                                                                    <div class="action-group">
                                                                        ...
                                                                        <form
                                                                            ...
                                                                            <button type="submit"
                                                                                class="btn btn-danger">Xóa BL</button>
                                                                        </form>
                                                                        ...
                                                                        <form
                                                                            ...
                                                                            <input type="hidden" name="reportId"
                                                                                value="${report.reportId}" />
                                                                            <button type="submit"
                                                                                class="btn btn-muted">Bỏ qua</button>
                                                                        </form>
                                                                        ...
                                                                        <div class="lock-wrapper"
                                                                            ...
                                                                            <div class="lock-dropdown">
                                                                                <div class="lock-option-label">Thời gian
                                                                                    khóa</div>
                                                                                ...
                                                                                <form
                                                                                    ...
                                                                                    <input type="hidden" name="reportId"
                                                                                        value="${report.reportId}" />
                                                                                    <input type="hidden" name="lockDays"
                                                                                        value="3" />
                                                                                    <button type="submit"
                                                                                        class="lock-option">🕒 3
                                                                                        ngày</button>
