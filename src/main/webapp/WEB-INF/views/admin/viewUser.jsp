                            ...
                            <div class="max-w-2xl">
                                <div class="profile-card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="info-grid">
                                            <div class="info-item">
                                                <div class="info-icon-box"><span class="material-icons">person</span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="info-item">
                                                <div class="info-icon-box"><span class="material-icons">badge</span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="info-item">
                                                <div class="info-icon-box"><span class="material-icons">email</span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="info-item">
                                                <div class="info-icon-box"><span class="material-icons">phone</span>
                                                </div>
                                                <div>
                                                    <p class="info-label">Số điện thoại</p>
                                                    <p class="info-value">${not empty user.phone ? user.phone : "Chưa
                                                        cập nhật"}</p>
                                                </div>
                                            </div>

                                            <div class="info-item">
                                                <div class="info-icon-box"><span class="material-icons">event</span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="info-item ">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="info-value">${not empty user.address ? user.address :
                                                        "Chưa cập nhật"}</p>
                                                </div>
                                            </div>
                                        </div>
