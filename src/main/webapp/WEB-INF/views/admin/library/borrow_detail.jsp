                        ...
                        <div class="row g-4">
                            <div class="col-md-6 border-end">
                                <div class="timeline-2-col">
                                    ...
                                    <div
                                        class="timeline-step ${record.status == 'RECEIVED' || record.status == 'RETURNED' || record.status == 'SHIPPING' ? 'completed' : ''} ${record.status == 'RECEIVED' || record.status == 'SHIPPING' ? 'active' : ''}">
