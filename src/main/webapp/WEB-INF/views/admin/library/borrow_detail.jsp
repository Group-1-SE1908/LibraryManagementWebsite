                    ...
                    <div class="info-card p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                <div class="value">${record.user.email} <span class="text-muted mx-2">|</span> ${record.user.phone}</div>
                            </div>
                            <div class="col-sm-12">
                                <div class="label">Địa chỉ (Hồ sơ)</div>
                                <div class="value text-muted">${not empty record.user.address ? record.user.address : 'Chưa cập nhật địa chỉ'}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="info-card p-4">
                        ...
                        <div class="d-flex gap-4">
                            <div style="width: 110px; flex-shrink: 0;">
                                <img src="${pageContext.request.contextPath}/${record.book.image}" class="book-cover" alt="Book cover">
                            </div>
