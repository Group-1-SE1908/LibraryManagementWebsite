                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="info-card p-4">
                                ...
                                <div><div class="label">Địa chỉ</div><div class="value text-muted small">${not empty record.user.address ? record.user.address : 'Chưa cập nhật'}</div></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-card p-4">
                        ...
                        <div class="info-card p-4 mt-4">
                            <h5 class="fw-bold mb-3 text-primary">📊 Thống kê Hoạt động</h5>
                            <div class="row g-3 text-center">
                                <div class="col-6 col-md-3 border-end">
                                    <div class="label">Sách đang mượn</div>
                                    <div class="value">${stats.currentBorrowed} / 5</div>
                                </div>
                                <div class="col-6 col-md-3 border-end">
                                    <div class="label">Còn lại</div>
                                    <div class="value">${stats.remaining} lượt</div>
                                </div>
                                <div class="col-6 col-md-3 border-end">
                                    <div class="label">Quá hạn?</div>
                                    <div class="value ${stats.hasOverdue ? 'text-danger' : 'text-success'}">
                                        ${stats.hasOverdue ? 'CÓ' : 'Không'}
                                    </div>
                                </div>
                                <div class="col-6 col-md-3">
                                    <div class="label">Tiền phạt nợ</div>
                                    <div class="value text-danger">${stats.unpaidFines} đ</div>
                                </div>
                                <div class="col-6 col-md-6 border-end mt-2">
                                    <div class="label">Tổng số sách đã mượn</div>
                                    <div class="value">${stats.totalHistory} cuốn</div>
                                </div>
                                <div class="col-6 col-md-6 mt-2">
                                    <div class="label">Số lần quá hạn</div>
                                    <div class="value text-warning">${stats.overdueCount} lần</div>
                                </div>
                            </div>
                        </div>
