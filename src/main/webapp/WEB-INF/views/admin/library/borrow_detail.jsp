                                            ...
                                            <c:when test="${record.status == 'RETURN_REQUESTED'}">
                                                <div class="alert alert-warning border-0 shadow-sm mb-4">
                                                    <h6 class="alert-heading fw-bold"><i
                                                            class="fas fa-truck-loading me-2"></i>Chờ nhập kho (Online)
                                                    </h6>
                                                    <p class="small mb-3">Độc giả đã gửi trả sách qua ship. Vui lòng
                                                        quét mã
                                                        vạch trên sách để hoàn tất.</p>
                                                    <div class="d-flex gap-2">
                                                        <input type="text" id="detail-bc" class="form-control"
                                                            placeholder="Nhập mã vạch sách...">
                                                        <button class="btn btn-success"
                                                            onclick="processDetailReturn(${record.id})">Xác
                                                            nhận</button>
                                                    </div>
                                                </div>
                                            </c:when>
