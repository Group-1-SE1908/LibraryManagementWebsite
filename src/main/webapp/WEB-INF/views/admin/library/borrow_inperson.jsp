            ...
            <div class="main-content">
                <div class="page-header">
                    <div>
                        ...
                        <p style="color: #64748b; margin-top: 5px;">Thực hiện quy trình cho mượn trực tiếp tại thư viện
                        </p>
                    </div>
                    <a href="${pageContext.request.contextPath}${borrowBase}"
                        style="text-decoration: none; color: var(--accent-blue); font-weight: 500;">
                        <i class="fas fa-arrow-left"></i> Quay lại danh sách
                    </a>
                </div>

                <form action="${pageContext.request.contextPath}${borrowBase}/inperson" method="post">
                        ...
                        <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" class="form-control"
                                    placeholder="Ví dụ: user01, SV12345..." required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <div style="display: flex; gap: 10px;">
                                    <input type="text" name="bookCopyId" class="form-control"
                                        placeholder="Nhập mã barcode trên sách..." required>
                                    <button type="button" class="btn-submit"
                                        style="width: auto; padding: 0 20px; background: var(--primary-dark);">
                            ...
                            <div class="form-group">
                                ...
                                <small style="color: #64748b; margin-top: 5px; display: block;">Thời gian mượn mặc định
                                    là 14 ngày.</small>
                            </div>
