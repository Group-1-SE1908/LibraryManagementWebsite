    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3 col-lg-2 d-md-block bg-white sidebar collapse border-end"
                    ...
                    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-5">
                                <div class="card p-4">
                                    <form action="${pageContext.request.contextPath}${staffBorrowBase}/inperson"
                                        method="post" id="mainBorrowForm">
                                    ...
                                    <div id="userResult" class="preview-card p-3 mb-4 shadow-sm" style="display:none;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted mb-0">ID: <span id="res-userId"
