                    ...
                    <div class="col-xl-10">
                        <div class="form-card">
                            <div class="form-header">
                                <h4 class="mb-0 text-center">${mode == 'create' ? '✨ THÊM SÁCH VÀO HỆ THỐNG' : '📝 CẬP NHẬT THÔNG TIN SÁCH'}</h4>
                            </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="isbn" class="form-control" value="${book.isbn}" 
                                                   ${mode=='edit' ? 'readonly' : ''} required placeholder="Ví dụ: 978-604-...">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="img-preview-box">
                                                <c:if test="${not empty book.image}">
                                                    <img id="currentImg" src="${pageContext.request.contextPath}/${book.image}" style="max-height: 120px;">
                                                    <p class="small text-muted mt-2">Ảnh hiện tại</p>
                                                </c:if>
                                                <img id="imgPreview" src="#" alt="Xem trước ảnh mới">
                                                <p id="previewText" class="small text-muted d-none">Xem trước ảnh mới</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="mt-5 d-flex justify-content-between align-items-center">
                                        <a href="${pageContext.request.contextPath}/books" class="text-decoration-none text-muted">
