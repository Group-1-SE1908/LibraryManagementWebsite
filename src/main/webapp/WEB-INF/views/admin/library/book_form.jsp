                        ...
                        <div class="form-card">
                            ...
                            <div class="card-body p-5">
                                <c:if test="${not empty error}">
                                    ...
                                    <%-- Hidden field để redirect về Import List sau khi lưu --%>
                                    <c:if test="${param.redirect == 'importList' || redirect == 'importList'}">
                                        <input type="hidden" name="redirect" value="importList">
                                    </c:if>

                                    <%-- Hidden fields cho mode Edit --%>
                                    <c:if test="${mode == 'edit'}">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="price" class="form-control"
                                                   value="${book.price}" placeholder="0" min="0" step="1000">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="img-preview-box mt-3">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:startsWith(book.image, 'http')}">
                                                            <img id="currentImg" src="${book.image}" 
                                                                 style="max-height: 180px; border-radius: 8px;" alt="Ảnh hiện tại">
                                                        </c:when>
                                                        <c:otherwise>
                                                            <img id="currentImg" 
                                                ...
                                                <img id="imgPreview" src="#" alt="Xem trước ảnh mới" style="display: none; max-height: 180px; border-radius: 8px;">
                                                <p id="previewText" class="small text-muted d-none mt-2">Xem trước ảnh mới</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="mt-5 d-flex justify-content-between align-items-center">
                                        <a href="${pageContext.request.contextPath}${booksBasePath}${param.redirect == 'importList' ? '?action=viewImportList' : ''}"
