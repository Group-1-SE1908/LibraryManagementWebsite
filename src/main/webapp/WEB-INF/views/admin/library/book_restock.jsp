...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .main-content {
                margin-left: 280px; /* Khớp với chiều rộng sidebar của bạn */
                padding: 40px;
    ...
    <body>
        ...
        <div class="main-content">
            <div class="card">
                ...
                <form action="${pageContext.request.contextPath}/books/restock" method="POST">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="${pageContext.request.contextPath}/books?action=viewImportList" class="btn btn-back">
                            Quay lại danh sách
                        </a>
                    </div>
                </form>
