                ...
                <div class="lib-sidebar">
                    ...
                    <div class="sidebar-footer">
                        <div class="profile-info">
                            ...
                            <div style="font-size: 13px; font-weight: 600;">${userName}</div>
                        </div>
                        <div class="sidebar-nav" style="padding: 0;">
                            <a href="${pageContext.request.contextPath}/profile"><i class="fas fa-user"></i> Hồ sơ</a>
                            <a href="${pageContext.request.contextPath}/"><i class="fas fa-home"></i> Trang chủ</a> <a
                                href="${pageContext.request.contextPath}/logout" style="color: #ef4444;">
