                ...
                <body>
                    ...
                    <main class="admin-main-content">
                        <div class="container py-4">
                            ...
                            <form action="${pageContext.request.contextPath}${borrowBase}" method="get"
                                class="filter-bar">
                                            ...
                                            <c:forEach items="${recordsInGroup}" var="r">
                                                <div class="book-item-row">
                                                    ...
                                                    <div class="book-actions">
                                                        ...
                                                        <c:if
                                                            test="${r.status == 'RECEIVED' || r.status == 'BORROWED' || r.status == 'SHIPPING'}">
                                                            ...
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                    <form
                                                                        ...
                                                                        <input type="hidden" name="id" value="${r.id}">
                                                                        <button type="submit"
                                                                            class="btn-modern primary">Độc giả đã
                                                                            nhận</button>
                                                                    </form>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        ...
                                                        <c:set var="pendingRenewal"
                                                            value="${pendingRenewalMap[r.id]}" />
                                                        <c:if test="${not empty pendingRenewal}">
                                                            ...
                                                            <a href="${pageContext.request.contextPath}${renewalBase}/view?id=${pendingRenewal.id}"
                                                                ...
                                                                style="padding: 8px 14px;">Xem yêu cầu gia hạn</a>
                                                        </c:if>
                                                    </div>
