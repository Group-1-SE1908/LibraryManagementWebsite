            ...
            <div class="main-content">
                ...
                <div class="search-container" style="margin-bottom: 20px;">
                    <form action="${pageContext.request.contextPath}${booksBasePath}" method="get">
                        ...
                        <input type="text" name="searchImport" value="${lastSearch}" placeholder="Tìm tên sách, ISBN..."
                            ...
                            <c:when test="${not empty bookList}">
                                <c:forEach items="${bookList}" var="book">
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                style="font-weight: bold; color: ${book.quantity < 5 ? '#ef4444' : '#1e293b'}">
                                                ${book.quantity}
                                            </span>
                                        </td>
                                        <td>
                            ...
                            <c:otherwise>
                                <tr>
                                    <td colspan="5" style="text-align: center; padding: 50px; color: #64748b;">
                                        ...
                                        <p style="font-size: 16px; margin: 0;">Không tìm thấy sách nào phù hợp với từ
                                            khóa "<strong>${lastSearch}</strong>".</p>
