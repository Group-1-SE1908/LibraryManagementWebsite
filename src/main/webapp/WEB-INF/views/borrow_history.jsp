                                    ...
                                    <tr data-copy-index="${entry.copyIndex}" data-copy-count="${entry.copyCount}">
                                        ...
                                        <td>
                                            <div class="table-actions-cell">
                                                ...
                                                <c:if test="${methodCode == 'ONLINE' && (fn:toUpperCase(r.status) == 'BORROWED' || fn:toUpperCase(r.status) == 'RECEIVED')}">
                                                    <a class="btn warning" 
                                                       href="${pageContext.request.contextPath}/borrow/returnOnline?id=${r.id}"
                                                       style="background-color: #f59e0b; color: white; border: none; padding: 6px 12px; border-radius: 6px; font-size: 0.8rem; text-decoration: none;"
                                                       onclick="return confirm('Bạn xác nhận muốn gửi yêu cầu trả sách qua dịch vụ vận chuyển?')">
                                                        📦 Trả qua Ship
                                                    </a>
                                                </c:if>
                                            </div>
