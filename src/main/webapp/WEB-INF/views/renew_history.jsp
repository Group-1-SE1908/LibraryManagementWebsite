...
<head>
    ...
    <title>Danh sách yêu cầu gia hạn</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .filter-tab {
            ...
            transition: all .15s; white-space: nowrap; display: flex; align-items: center; gap: 0;
        }
        ...
        .count-badge {
            ...
            min-width: 18px; margin-left: 5px; font-weight: 600;
        }
        ...
        .search-box input {
            ...
            font-size: .85rem; color: var(--text); background: transparent; width: 220px;
        }
        ...
        .empty-state__text { font-size: .9rem; color: var(--text-soft); }
        ...
        .book-icon {
            width: 36px; height: 36px; border-radius: 6px; background: var(--primary-light);
            display: flex; align-items: center; justify-content: center; flex-shrink: 0; color: var(--primary);
        }
        .book-title { font-weight: 600; color: var(--text); font-size: .88rem; }
        .book-meta { font-size: .76rem; color: var(--text-muted); margin-top: 2px; }

        .contact-name { font-weight: 500; color: var(--text); font-size: .88rem; }
        .contact-sub { font-size: .77rem; color: var(--text-muted); margin-top: 1px; }

        .reason-text {
            font-size: .83rem; color: var(--text-soft); max-width: 200px; line-height: 1.45;
        ...
        .badge--pending  { background: var(--pending-bg);  color: var(--pending-tx);  border-color: var(--pending-bd); }
        .badge--pending  .badge__dot { background: var(--pending-tx); }
        .badge--approved { background: var(--approved-bg); color: var(--approved-tx); border-color: var(--approved-bd); }
        .badge--approved .badge__dot { background: var(--approved-tx); }
        .badge--rejected { background: var(--rejected-bg); color: var(--rejected-tx); border-color: var(--rejected-bd); }
        .badge--rejected .badge__dot { background: var(--rejected-tx); }
...
<header class="page-header">
    <div class="page-header__inner">
        ...
        <div>
            <div class="page-header__title">Danh sách yêu cầu gia hạn</div>
            <div class="page-header__sub">Theo dõi trạng thái các yêu cầu gia hạn sách của bạn</div>
        </div>
    </div>
</header>
