                                            ...
                                            <c:when test="${not empty comments}">
                                                <div class="comments-list">
                                                    <c:forEach var="comment" items="${comments}">
                                                        <article class="comment-card" id="comment-${comment.commentId}">
                                                                ...
                                                                <div class="comment-user-info">
                                                                    ...
                                                                    <div class="comment-meta">
                                                                        ...
                                                                        <div class="comment-rating">
                                                                            <c:forEach begin="1" end="${comment.rating != null ? comment.rating : 0}">
                                                                                <span class="star">★</span>
                                                                            </c:forEach>
                                                                        </div>
                                                                        <span class="comment-date">
                                    <c:if test="${comment.createdAt != null}">
                                        <fmt:formatDate value="${comment.createdAt}" type="date" dateStyle="medium" />
                                                                ...
                                                                <div class="comment-actions">
                                                                    ...
                                                                    <c:if test="${not empty sessionScope.currentUser && (sessionScope.currentUser.id == comment.userId || sessionScope.currentUser.role.name == 'ADMIN' || sessionScope.currentUser.role.name == 'LIBRARIAN')}">
                                                                        <button type="button" class="btn ghost btn-action btn-primary"
                                                                    ...
                                                                    <button type="button" class="btn ghost btn-action btn-warning"
                                                                            onclick="openReportModal('${comment.commentId}')">
                                                                        Báo cáo
                                                                    </button>
                                                                </div>
                                                            </header>
                                                            <p class="comment-content ${fn:length(comment.content) > 200 ? 'truncated' : ''}" data-full-content="${fn:escapeXml(comment.content)}">
                                                                <c:out value="${comment.content}" />
                                                                <c:if test="${fn:length(comment.content) > 200}">
                                                                    <span class="read-more-btn" onclick="toggleComment(this)">Đọc thêm</span>
                                                                </c:if>
                                                            </p>
                                                                    ...
                                                                    <c:forEach var="reply" items="${comment.replies}">
                                                                        <div class="reply-card">
                                                                            <div class="reply-card__header">
                                                                                ...
                                                                                <span class="comment-date">
                                            &bull;
                                            <fmt:formatDate value="${reply.createdAt}" type="both" dateStyle="medium" timeStyle="short" />
                                        </span>
                                                                            </div>
                                            ...
                                            <form id="reportForm">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="reportReason" name="reason" required>
                                                        ...
                                                        <option value="Offensive language">Ngôn ngữ thô tục</option>
                                                ...
                                                <div class="form-group">
                                                    <label for="reportDescription">Mô tả chi tiết (tùy chọn)</label>
                                                    <textarea id="reportDescription" name="description" rows="3" placeholder="Cung cấp thêm chi tiết..."></textarea>
                                                </div>

                                                <div class="modal-actions">
                                                    <button type="button" class="btn secondary" onclick="closeReportModal()">Hủy</button>
