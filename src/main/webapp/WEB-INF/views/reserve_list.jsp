            ...
            <head>
                ...
                <style>
                    ...
                    *::after {
                    ...
                    .reserve-hero__limit.warn {
                        background: rgba(254, 243, 199, 0.25);
                        border-color: rgba(251, 191, 36, 0.6);
                    }

                    .reserve-hero__limit.full {
            ...
            <body>
                ...
                <div class="main-wrap">
                    ...
                    <section class="reserve-hero">
                        <div class="reserve-hero__inner">
                            <div>
                                <p class="reserve-hero__eyebrow">Đặt trước</p>
                                <h1>Danh sách đặt trước sách</h1>
                                <p class="lead">Theo dõi trạng thái các sách bạn đã đặt trước</p>
                            </div>
                            <div class="reserve-hero__card">
                                <h3>Slot đang sử dụng</h3>
                                <div class="reserve-hero__stat">${activeCount} <span
                                        style="font-size:1.4rem;opacity:.75">/ ${maxReservations}</span></div>
                                <small>đặt trước đang hoạt động</small>
                                <br>
                                <span
                                    class="reserve-hero__limit ${activeCount >= maxReservations ? 'full' : activeCount >= maxReservations - 1 ? 'warn' : ''}">
                            ...
                            <c:when test="${empty reservations}">
                                <div class="empty-state">
                                    ...
                                    <p class="empty-state__sub">
                                        Khi sách bạn muốn mượn hết hàng, hãy đặt trước để được<br />thông báo ngay khi
                                        sách có sẵn.
                                    </p>
                                    <a href="${pageContext.request.contextPath}/books" class="btn-add">
                                                ...
                                                <tr data-status="${res.status}"
                                                    ...
                                                    <td data-label="Sách">
                                                        <div class="book-cell">
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                    <div class="book-thumb-ph"><i
                                                                            class="bi bi-book"></i></div>
                                                                </c:otherwise>
                                                            </c:choose>
                                                            <div>
                                                                <div class="book-title" title="${res.bookTitle}">
                                                                    ${res.bookTitle}</div>
                                                    ...
                                                    <%-- Cột queue_position: chỉ hiện khi đang WAITING --%>
                                                        <td data-label="Vị trí hàng chờ">
                                                            <c:choose>
                                                                <c:when
                                                                    test="${res.status == 'WAITING' && res.queuePosition != null}">
                                                                ...
                                                                <c:when test="${res.status == 'AVAILABLE'}">
                                                                    <span
                                                                        style="color:#166534;font-size:.8rem;font-weight:600">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${not empty res.expiredAt}">
                                                                    ...
                                                                    <%-- Cảnh báo nếu còn <=1 ngày --%>
                                                                        <c:if
                                                                            test="${res.daysUntilExpiry <= 1 && res.daysUntilExpiry >= 0}">
                                                                            <div class="date-warning">
                                                                                <i
                                                                                    class="bi bi-exclamation-triangle-fill"></i>
                                                                                Còn ${res.daysUntilExpiry == 0 ? 'hôm
                                                                                nay' : '1 ngày'}!
                                                                            </div>
                                                                        </c:if>
                                                                </c:when>
                                                        ...
                                                        <td data-label="Thao tác">
                                                            <c:choose>
                                                                <c:when
                                                                    test="${res.status == 'WAITING' || res.status == 'AVAILABLE'}">
                                                                    <form method="post"
