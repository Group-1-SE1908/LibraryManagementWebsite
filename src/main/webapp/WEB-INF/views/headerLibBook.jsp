        ...
        <header class="header-lib shadow-sm sticky-top border-bottom bg-white">
            <nav class="navbar navbar-expand-lg navbar-light container-fluid px-4">
                <a class="navbar-brand d-flex align-items-center" href="${pageContext.request.contextPath}/home">
                    <img src="${pageContext.request.contextPath}/assets/images/logo/logo.png" alt="LBMS" width="40"
                        class="mr-2">
                    <span class="font-weight-bold text-primary" style="letter-spacing: 1px;">LBMS LIBRARIAN</span>
                </a>

                <button class="navbar-toggler border-0" type="button" data-toggle="collapse"
                    data-target="#librarianNav">
                        ...
                        <div class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown"
                                ...
                                <div class="avatar-sm mr-2 bg-primary text-white rounded-circle d-flex align-items-center justify-content-center"
                                    ...
                                    ${not empty user ? user.fullName.substring(0,1).toUpperCase() : 'U'}
                                </div>
                                <span class="d-none d-md-inline text-dark">${not empty user ? user.fullName :
                                    'User'}</span>
                            </a>
