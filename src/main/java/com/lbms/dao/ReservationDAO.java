...
public class ReservationDAO {
    ...
    public long create(long userId, long bookId) throws SQLException {
        String sql = "INSERT INTO reservations(user_id, book_id, created_at, status) VALUES(?, ?, GETDATE(), 'WAITING')";
        try (Connection c = DBConnection.getConnection();
    ...
    private String baseSelect() {
        return "SELECT r.id AS reservation_id, r.user_id, r.book_id, r.status, r.created_at, " +
