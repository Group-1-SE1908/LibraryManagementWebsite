...
public class UserDAO {
    ...
    public User findByEmail(String email) throws SQLException {
        String sql = "SELECT u.user_id, u.email, u.password, u.name, u.status, u.role_id, u.phone, u.address,u.created_at, r.role_name "
    ...
    public boolean isPhoneExists(String phone, long excludeUserId) throws SQLException {
    ...
    /*
    Đoạn này chỉ để fix lỗi
    */
    
    public void updateRole(long userId, String name) {
