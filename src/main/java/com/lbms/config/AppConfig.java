...
public final class AppConfig {
    ...
    public static final String APP_BASE_URL = System.getenv().getOrDefault("LBMS_APP_BASE_URL",
            "http://localhost:8080/lbms");

    public static final int RESET_TOKEN_MINUTES = Integer
            .parseInt(System.getenv().getOrDefault("LBMS_RESET_TOKEN_MINUTES", "15"));

    // GHTK config via environment variables
    public static final String GHTK_API_BASE_URL = System.getenv().getOrDefault("LBMS_GHTK_API_BASE_URL",
